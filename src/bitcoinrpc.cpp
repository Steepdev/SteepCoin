...
{
    return GetBoolArg("-testnet", false) ? 36469 : 36467;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop SteepCoin server (and possibly override the detachdb config value).");
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("SteepCoin-rpclist");
...
void ThreadRPCServer2(void* parg)
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use SteepCoind";
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("SteepCoin-rpchand");
