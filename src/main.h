...
static const int STAKE_TARGET_SPACING = 1 * 120; // 2 minute block
...
static const int STAKE_MIN_AGE = 60 * 60 * 4; // 4 hours
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 30;  // 30 days
...
public:
    ...
    // Context-independent validity checks
    bool CheckBlock(int pos,CValidationState &state, bool fCheckPOW=true, bool fCheckMerkleRoot=true) const;
