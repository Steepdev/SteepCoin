...
Once you've got the right hardware and software:
    ...
    wget -O miniupnpc-1.6.tar.gz 'http://miniupnp.tuxfamily.org/files/download.php?file=miniupnpc-1.9.20151026.tar.gz'
    ...
    wget 'https://downloads.sourceforge.net/project/libpng/libpng15/older-releases/1.6.12/libpng-1.6.12.tar.gz'
    wget 'http://ftp.lfs-matrix.net/pub/blfs/conglomeration/qt4/qt-everywhere-opensource-src-4.8.6.tar.gz'
    cd ../..
    ...
    cd ../gitian-builder
    git pull
    sudo ./bin/gbuild --commit SteepCoin=HEAD ../SteepCoin/contrib/gitian-descriptors/gitian.yml

    # Build Win32 dependencies: (only needs to be done once, or when dependency versions change)
    sudo ./bin/gbuild --commit SteepCoin=HEAD ../SteepCoin/contrib/gitian-descriptors/boost-win32.yml
    mv build/out/*.* inputs/
    sudo ./bin/gbuild --commit SteepCoin=HEAD ../SteepCoin/contrib/gitian-descriptors/deps-win32.yml
    mv build/out/*.* inputs/
    sudo ./bin/gbuild --commit SteepCoin=HEAD ../SteepCoin/contrib/gitian-descriptors/qt-win32.yml
    mv build/out/*.* inputs/

    # Build Win32 release:
    sudo ./bin/gbuild --commit SteepCoin=HEAD ../SteepCoin/contrib/gitian-descriptors/gitian-win32.yml
...
If you need more help please visit SteepCoin thread on Bitcointalkforum.
